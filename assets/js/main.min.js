...
$.extend($.easing, {
  ...
  (function (t) {
    var e, i, a, n, o, s, r;
    (havetic.$window = t(window)),
      (havetic.$body = t(document.body)),
      (havetic.status = ""),
      (havetic.isIE = navigator.userAgent.indexOf("Trident") >= 0),
      (havetic.isEdge = navigator.userAgent.indexOf("Edge") >= 0),
      (havetic.isMobile =
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        )),
      (havetic.call = function (t, e) {
        setTimeout(t, e);
      }),
      (havetic.parseOptions = function (t) {
        return "string" == typeof t
          ? JSON.parse(t.replace(/'/g, '"').replace(";", ""))
          : {};
      }),
      (havetic.parseTemplate = function (t, e) {
        return t.replace(/\{\{(\w+)\}\}/g, function () {
          return e[arguments[1]];
        });
      }),
      (havetic.byId = function (t) {
        return document.getElementById(t);
      }),
      (havetic.byTag = function (t, e) {
        return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
      }),
      (havetic.byClass = function (t, e) {
        return e
          ? e.getElementsByClassName(t)
          : document.getElementsByClassName(t);
      }),
      (havetic.setCookie = function (t, e, i) {
        var a = new Date();
        a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
          (document.cookie =
            t + "=" + e + ";expires=" + a.toUTCString() + ";path=/");
      }),
      (havetic.getCookie = function (t) {
        for (
      ...
      (havetic.requestTimeout = function (t, e) {
        var i =
      ...
      (havetic.requestInterval = function (t, e, i) {
        var a =
          window.requestAnimationFrame ||
          window.webkitRequestAnimationFrame ||
          window.mozRequestAnimationFrame;
      ...
      (havetic.deleteTimeout = function (t) {
        if (t) {
          var e =
      ...
      (havetic.initCartAction = function (e) {
        havetic.$body
      ...
      (havetic.initScrollTopButton = function () {
        var e = havetic.byId("scroll-top");
      ...
      (havetic.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0,
      }),
      (havetic.stickyProductOptions = {
        minWidth: 0,
        maxWidth: 2e4,
        scrollMode: !0,
        top: !1,
      ...
      (havetic.windowResized = function (e) {
        return (
          e == havetic.resizeTimeStamp ||
            (void 0 === window.innerHeight &&
              (window.innerWidth =
                t(window).width() + havetic.getScrollbarWidth()),
            (havetic.resizeChanged = havetic.canvasWidth != window.innerWidth),
            (havetic.canvasWidth = window.innerWidth),
            (havetic.resizeTimeStamp = e)),
          havetic.resizeChanged
        );
      }),
      (havetic.getScrollbarWidth = function () {
        if (void 0 === havetic.scrollbarSize) {
          var t = document.createElement("div");
          (t.style.cssText =
            "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"),
            document.body.appendChild(t),
            (havetic.scrollbarSize = t.offsetWidth - t.clientWidth),
            document.body.removeChild(t);
        }
        return havetic.scrollbarSize;
      }),
      (havetic.stickyContent = (function () {
        function e(t, e) {
          return this.init(t, e);
        }
        function i() {
          havetic.$window.trigger("sticky_refresh.havetic", {
            index: 0,
            offsetTop: 0,
          });
        }
        function a(t) {
          (t && !havetic.windowResized(t.timeStamp)) ||
            (havetic.$window.trigger("sticky_refresh_size.havetic"), i());
        }
        return (
          (e.prototype.init = function (e, i) {
            (this.$el = e),
              (this.options = t.extend(
                ...
                havetic.stickyDefaultOptions,
                i,
                havetic.parseOptions(e.attr("data-sticky-options"))
              )),
              havetic.$window
                .on("sticky_refresh.havetic", this.refresh.bind(this))
                .on("sticky_refresh_size.havetic", this.refreshSize.bind(this));
          }),
                    ...
                    (this.scrollPos <= i && a.hasClass("fix-bottom"))
                      ? (a.addClass("fixed"),
                        ...
                        a.hasClass("product-sticky-content") &&
                          havetic.$body.addClass("addtocart-fixed"))
                      : (a
                          .removeClass("fixed")
                          .css("margin-top", "")
                          .css("margin-bottom", ""),
                        ...
                        a.hasClass("product-sticky-content") &&
                          havetic.$body.removeClass("addtocart-fixed")),
                    (this.scrollPos = i))
                  : (a.addClass("fixed"), this.onFixed && this.onFixed()),
                a.is(".fixed.fix-top")
                  ? ((e.offsetTop += a[0].offsetHeight),
                    (havetic.sticky_top_height = e.offsetTop))
          ...
          havetic.$window.on("havetic_complete", function () {
            window.addEventListener("scroll", i, { passive: !0 }),
              havetic.$window.on("resize", a),
              setTimeout(function () {
                a();
              }, 300);
          }),
          function (i, a) {
            havetic.$(i).each(function () {
              var i = t(this);
      ...
      (havetic.parallax = function (e, i) {
        t.fn.themePluginParallax &&
          havetic.$(e).each(function () {
            var e = t(this);
            e.themePluginParallax(
              t.extend(
                !0,
                havetic.parseOptions(e.attr("data-parallax-options")),
                i
              )
            );
          });
      }),
      (havetic.skrollrParallax = function () {
        havetic.isMobile ||
          ("undefined" != typeof skrollr &&
            havetic.$(".skrollable").length &&
            skrollr.init({ forceHeight: !1 }));
      }),
      (havetic.initFloatingParallax = function () {
        t.fn.parallax &&
          havetic.$(".floating-item").each(function (e) {
            var i = t(this);
            i.data("parallax") &&
              (i.parallax("disable"),
              ...
              i.parallax(havetic.parseOptions(i.data("options")));
          });
      }),
      (havetic.isotopeOptions = {
        itemsSelector: ".grid-item",
        layoutMode: "masonry",
        percentPosition: !0,
        masonry: { columnWidth: ".grid-space" },
      }),
      (havetic.isotopes = function (e, i) {
          ...
          havetic.$(e).each(function () {
            var e = t(this),
              n = t.extend(
                ...
                {},
                a.isotopeOptions,
                havetic.parseOptions(e.attr("data-grid-options")),
                i || {}
              );
            havetic.lazyLoad(e),
      ...
      (havetic.initNavFilter = function (e) {
        t.fn.isotope &&
          havetic.$(e).on("click", function (e) {
            var i = t(this),
            ...
            t(n || ".grid")
              ...
              .isotope("on", "arrangeComplete", function () {
                havetic.$window.trigger("appear.check");
              }),
      ...
      (havetic.ratingTooltip = function (t) {
        for (
          var e = havetic.byClass("ratings-full", t || document.body),
            i = e.length,
            a = function () {
              var t =
      ...
      (havetic.setProgressBar = function (e) {
        havetic.$(e).each(function () {
          var e = t(this),
      ...
      (havetic.alert = function (e) {
        havetic.$body.on("click", e + " .btn-close", function (i) {
          i.preventDefault(),
            t(this)
              .closest(e)
              .fadeOut(function () {
      ...
      (havetic.closeTopNotice = function (e) {
        havetic.$body.on("click", e, function (e) {
          e.preventDefault(), t(".top-banner").slideUp();
        });
      }),
      (havetic.accordion = function (e) {
        havetic.$body.on("click", e, function (e) {
          var a = t(this),
      ...
      (havetic.animationOptions = {
        name: "fadeIn",
        duration: "1.2s",
        delay: ".2s",
      }),
      (havetic.appearAnimate = function (e) {
        havetic.$(e).each(function () {
          var e = this;
          havetic.appear(e, function () {
            if (e.classList.contains("appear-animate")) {
              var i = t.extend(
                {},
                havetic.animationOptions,
                havetic.parseOptions(e.getAttribute("data-animation-options"))
              );
              setTimeout(
                function () {
      ...
      (havetic.priceSlider = function (e, i) {
      ...
      (havetic.stickySidebar = function (e) {
        if (t.fn.themeSticky) {
          var i = 0;
          function a() {
            havetic.$(e).trigger("recalc.pin"),
          ...
          !t(".sticky-sidebar > .filter-actions").length &&
            ...
            setTimeout(a, 300),
            havetic.$window.on("click", ".tab .nav-link", function () {
              setTimeout(a);
            });
        }
      }),
      (havetic.zoomImageOptions = {
        responsive: !0,
        borderSize: 0,
        zoomType: "inner",
        onZoomIn: !0,
      ...
      (havetic.zoomImageObjects = []),
      (havetic.zoomImage = function (e) {
        t.fn.zoom &&
          e &&
          ("string" == typeof e ? t(e) : e).find("img").each(function () {
            var e = t(this);
            (havetic.zoomImageOptions.target = e.parent()),
              (havetic.zoomImageOptions.url = e.attr("data-zoom-image")),
              e.zoom(havetic.zoomImageOptions),
              havetic.zoomImageObjects.push(e);
          });
      }),
      (havetic.zoomImageOnResize = function () {
        havetic.zoomImageObjects.forEach(function (e) {
          e.each(function () {
      ...
      (havetic.lazyLoad = function (t, e) {
        ...
        havetic
          ...
          .find(".lazy-img")
          .each(function () {
            void 0 !== e && e ? i.call(this) : havetic.appear(this, i);
          });
      }),
      (havetic.initPopup = function (e, i) {
        havetic.$body.hasClass("home") &&
          "true" !== havetic.getCookie("hideNewsletterPopup") &&
          // setTimeout(function () {
          //   havetic.popup({
          ...
          //           havetic.setCookie("hideNewsletterPopup", !0, 7);
          //       },
          //     },
          //   });
          // }, 7500),
          havetic.$body.on("click", ".btn-iframe", function (e) {
            e.preventDefault(),
              havetic.popup(
                {
                  items: {
      ...
      (havetic.initNotificationAlert = function () {
        havetic.$body.hasClass("has-notification") &&
          setTimeout(function () {
            havetic.$body.addClass("show-notification");
          }, 5e3);
      }),
      (havetic.countTo = function (e) {
        t.fn.countTo &&
          havetic.$(e).each(function () {
            havetic.appear(this, function () {
              var e = t(this);
              setTimeout(function () {
                e.countTo({
                  onComplete: function () {
        ...
        }),
        {
          init: function () {
            ...
            (i.className = "minipopup-area"),
              havetic.byClass("page-wrapper")[0].appendChild(i),
              (e = t(i)),
          ...
          open: function (n, l) {
            var c,
              d = this,
              p = t.extend(!0, {}, havetic.minipopupOption, n);
            (c = t(havetic.parseTemplate(p.template, p))), (d.space = p.space);
            ...
            u.length &&
              u.on("load", function () {
                (i += c[0].offsetHeight + d.space),
                  ...
                  havetic.$body.on("touchstart", function () {
                    d.resume();
                  }),
                  a.push(c),
      ...
      (havetic.headerToggleSearch = function (t) {
        var e = havetic.$(t);
        havetic.$body.on("click", ".hs-toggle .search-toggle", function (t) {
          t.preventDefault();
        }),
          "ontouchstart" in document
            ? (e.find(".search-toggle").on("click", function (t) {
              ...
              havetic.$body.on("click", function (t) {
                e.removeClass("show");
              }),
  ...
  (function (t) {
    var e = function (t) {
        t.preventDefault(), havetic.$body.addClass("mmenu-active");
      },
      i = function (t) {
        t.preventDefault(), havetic.$body.removeClass("mmenu-active");
      },
      a = {
        init: function () {
          this.initMenu(),
        ...
        initMenu: function () {
          t(".menu li").each(function () {
            ...
            havetic.$window.on("resize", function () {
  ...
  (function (t) {
      ...
      a = function (t) {
        ...
        for (e = 0; e < a; ++e)
          if (!i[e].classList.contains("active")) {
            var n,
              o = havetic.byClass("appear-animate", i[e]);
          ...
          .each(function () {
            var i = t(this),
              a = t.extend(
                ...
                {},
                havetic.animationOptions,
                havetic.parseOptions(i.data("animation-options"))
              ),
              n = a.duration,
              o = a.delay,
              s = a.name;
          ...
          a.find(".swiper-slide .slide-animate").each(function () {
            var e = t(this),
              i = t.extend(
                ...
                {},
                havetic.animationOptions,
                havetic.parseOptions(e.data("animation-options"))
              );
          ...
          if (
            ...
            if (
              ...
              for (var n = 0; n < i.timers.length; n++)
                havetic.deleteTimeout(i.timers[n]);
              i.timers = [];
            }
    ...
    (e.defaults = { slidesPerView: 1, speed: 300 }),
        ...
        if (!c.data("slider")) {
          ...
          f.forEach(function (i) {
            ...
            t.extend(
              !0,
              g,
              havetic.parseOptions(c.attr("data-swiper-options")),
              d
            ),
            i.call(this),
      ...
      (havetic.slider = function (i, a = {}, n = !1) {
        havetic.$(i).each(function () {
          var i = t(this);
          n
            ? new e(i, a)
      ...
      (havetic.slider.pgToggle = function () {
    ...
    (e.prototype.init = function (e) {
      ...
      return (
        ...
        a.$sidebar.length &&
          ...
          a.isNavigation &&
            ((i = i.bind(this)), havetic.$window.on("resize", i)),
          havetic.$window.on("resize", function (t) {
            havetic.windowResized(t.timeStamp) &&
              havetic.$body.removeClass(e + "-active");
          }),
          a.$sidebar
          ...
          a.$sidebar
            ...
            .on("click", function (t) {
              havetic.$body.removeClass(e + "-active"), t.preventDefault();
            })),
        !1
      );
    }),
      (e.prototype.toggle = function () {
        ...
        if (
          ...
          e.$sidebar
            ...
            havetic.$body.toggleClass(e.name + "-active").removeClass("closed");
        setTimeout(function () {
          t(window).trigger("appear.check");
        }, 400);
      }),
      (havetic.sidebar = function (t) {
        return new e().init(t);
      });
  })(jQuery),
  (function (t) {
    var e = {
      init: function () {
        var e;
        havetic.call(havetic.ratingTooltip, 500),
          havetic.call(havetic.setProgressBar(".progress-bar"), 500),
          this.initVariation(),
          ...
          havetic.$body.on("click", ".select-menu a", function (t) {
            t.preventDefault();
          }),
          havetic.$body.on("click", ".selected-item i", function (e) {
            t(e.currentTarget)
              .parent()
              .fadeOut(function () {
                var e = t(this),
          ...
          havetic.$body.on("mousedown", function (e) {
            t(".select-menu").removeClass("opened");
          }),
          havetic.$body.on("click", ".filter-items a", function (e) {
          ...
          (e = t(".product-popup")).length &&
            havetic.$body.on("click", ".btn-quickview", function (i) {
              i.preventDefault(),
                havetic.popup(
                  {
          ...
          (function () {
            ...
            a.length ||
                ...
                .on("click", ".product .btn-compare", function (o) {
                  ...
                  i.length >= 4 && i.shift(),
                    ...
                    t(".compare-popup li").each(function (t) {
                      i[t] &&
                        (this.innerHTML =
                          '<a href="product-without-sidebar.html"><figure><img src="' +
                          i[t] +
              ...
              havetic.$body.on("click", ".compare-popup-overlay", function () {
                a.removeClass("show");
              });
          })(),
          havetic.priceSlider(".filter-price-slider");
      },
                ...
                a.data("load-state", "loading"),
                  ...
                  setTimeout(function () {
                    a.next().removeClass("loading"),
                      ...
                      havetic.countDown(i.find(".product-countdown"));
                  }, 500);
                var n = parseInt(
    ...
    (e.min = 1),
      ...
      (e.prototype.startIncrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.increaseTimer = havetic.requestTimeout(function () {
            (e.speed = 1),
              (e.increaseTimer = havetic.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.min(
      ...
      (e.prototype.startDecrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.decreaseTimer = havetic.requestTimeout(function () {
            (e.speed = 1),
              (e.decreaseTimer = havetic.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.max(
                    e.value - Math.floor((e.speed *= 1.05)),
                    e.min
      ...
      (e.prototype.stop = function (t) {
        havetic.deleteTimeout(this.increaseTimer),
          havetic.deleteTimeout(this.decreaseTimer);
      }),
      (havetic.initQtyInput = function (i) {
        havetic.$(i).each(function () {
          var i = t(this);
    ...
    (e.defaults = {
      ...
      (e.prototype.init = function (i, a) {
        ...
        n.isOpen
          ...
          havetic.$body.on("mousedown", ".mfp-wrap", o),
          "ontouchstart" in document &&
            document.addEventListener("touchstart", o, { passive: !0 });
      }),
      (havetic.popup = function (t, i) {
        return new e(t, i);
      });
  })(jQuery),
  (function (t) {
    ...
    (e.prototype.init = function (e) {
      ...
      (o.$wrapper = e),
        ...
        (o._isPgVertical = !1),
        o.isQuickView && ((i = i.bind(this)), havetic.ratingTooltip()),
        (function (t) {
        ...
        "complete" === havetic.status &&
          (havetic.slider(s, {
            thumbs: { swiper: o.$thumbsWrap.data("slider") },
          }),
          havetic.initQtyInput(e.find(".quantity"))),
        s.length &&
          window.addEventListener(
            "resize",
            function () {
              havetic.requestTimeout(function () {
                null != s.data("slider") &&
        ...
        o.$wrapper
          ...
          .on("initialized.slider", function (e) {
            t(e.target).find(".product-image").zoom(havetic.zoomImageOptions);
          }),
      ...
      (e.prototype.clickStickyThumbnail = function (e) {
        ...
        o.length && ((o = o.offset().top + 10), havetic.scrollTo(o, 500)),
          setTimeout(function () {
      ...
      (havetic.productSingle = function (i) {
        return (
          havetic.$(i).each(function () {
            var i = t(this);
  ...
  (function (t) {
    ...
    havetic.initProductSinglePage = function () {
      t(".product-gallery").each(function () {
        var e = t(this),
          i = e.find(".product-image");
        i.length &&
          0 == e.find(".swiper-container").length &&
          i.zoom(havetic.zoomImageOptions);
      }),
        (function (e) {
          var i = t(e),
  ...
  (function (t) {
    havetic.initCodePopup = function () {
      t(".box-btn.showcode span").each(function () {
        ...
        havetic.$body.on("click", ".box-btn.showcode", function () {
          var e = t(this);
          e.hasClass("enabled")
        ...
        havetic.$body.on("click", ".show-code", function (e) {
          e.stopPropagation();
          var i = t(this).parent();
          if (i.hasClass("show-code-added")) {
            ...
            i[0].removeChild(a),
              ...
              havetic.$body.on("click", ".code-copy a", function (e) {
                e.preventDefault(),
  ...
  (function (t) {
    ...
    (e.defaultOptions = {
      ...
      (e.prototype.init = function (a, n) {
        ...
        (o.element = a),
          (o.settings = t.extend(
            ...
            !0,
            e.defaultOptions,
            havetic.parseOptions(a.attr("data-calendar-options")),
            n
          )),
          (o.today = new Date()),
          (i = i.bind(this));
      ...
      (havetic.slideContent = function (e) {
        var i = t(e),
          a = i.next();
      ...
      (havetic.initLoginVendor = function (e) {
        var i = t(e),
  ...
  jQuery,
  (havetic.initLayout = function () {
    havetic.isotopes(".grid:not(.grid-float)"),
      havetic.stickySidebar(".sticky-sidebar");
  }),
  (havetic.init = function () {
    havetic.appearAnimate(".appear-animate"),
      havetic.setTab(".nav-tabs"),
      havetic.stickyContent(".sticky-header", { scrollMode: !1 }),
      havetic.stickyContent(".sticky-footer", {
        minWidth: 0,
        maxWidth: 767,
        top: 150,
        hide: !0,
      ...
      havetic.stickyContent(".sticky-toolbox", havetic.stickyToolboxOptions),
      havetic.stickyContent(
        ".product-sticky-content",
        havetic.stickyProductOptions
      ),
      havetic.parallax(".parallax"),
      havetic.skrollrParallax(),
      havetic.initFloatingParallax(),
      havetic.menu.init(),
      havetic.initScrollTopButton(),
      havetic.shop.init(),
      havetic.alert(".alert"),
      havetic.closeTopNotice(".banner-close"),
      havetic.accordion(".card-header > a"),
      havetic.sidebar("sidebar"),
      havetic.sidebar("right-sidebar"),
      havetic.productSingle(".product-single"),
      havetic.initProductSinglePage(),
      havetic.initQtyInput(".quantity"),
      havetic.initNavFilter(".nav-filters .nav-filter"),
      havetic.calendar(".calendar-container"),
      havetic.countDown(".product-countdown, .countdown"),
      havetic.initPopup(),
      havetic.initNotificationAlert(),
      havetic.countTo(".count-to"),
      havetic.initCartAction(".cart-offcanvas .cart-toggle"),
      havetic.Minipopup.init(),
      havetic.headerToggleSearch(".hs-toggle"),
      havetic.initVendor(".store"),
      havetic.slideContent(".login-toggle"),
      havetic.slideContent(".coupon-toggle"),
      havetic.slideContent(".checkbox-toggle"),
      havetic.initLoginVendor(".user-checkbox"),
      havetic.initCodePopup(),
      havetic.slider(".swiper-container"),
      havetic.call(havetic.slider.pgToggle),
      havetic.$window.on("resize", function () {
        havetic.call(havetic.slider.pgToggle);
      });
  }),
  ...
  (window.onload = function () {
    (havetic.canvasWidth = window.innerWidth),
      (havetic.resizeTimeStamp = 0),
      (havetic.resizeChanged = !1),
      (havetic.status = "loaded"),
      document.body.classList.add("loaded"),
      havetic.call(havetic.initLayout),
      havetic.call(havetic.init),
      (havetic.status = "complete"),
      havetic.$window.trigger("havetic_complete");
  });

// $(".banner_part").slick();

console.log("hello9", document);
