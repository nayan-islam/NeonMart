  ...
  function be(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && w.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = ie(o)), (a = ye(f.appendChild(o), "script")), l && me(a), n)
      )
            ...
            d &&
              ...
              (p = u[d]) ||
                ...
                (f.setup && !1 !== f.setup.call(e, r, h, a)) ||
                  (e.addEventListener &&
                    ("scroll" == d
                      ? e.addEventListener(d, a, { passive: !0 })
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && A(t, "input") && Ne(t, "click", Ee),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && A(t, "input") && Ne(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Ie(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || w.cleanData(ye(r)),
        r.parentNode &&
          (n && ie(r) && me(ye(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = ye(s, "script")).length > 0 && me(a, !u && ye(e, "script")), s
      );
    },
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ge(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n)
        )
  ...
  w.ajaxSetup({
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = ze(d.pixelPosition, function (e, n) {
        if (n)
          return (n = _e(e, t)), We.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
