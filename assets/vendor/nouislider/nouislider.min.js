...
!(function (a) {
  ...
  function q() {
    return window.navigator.pointerEnabled
      ? { start: "pointerdown", move: "pointermove", end: "pointEURp" }
      : window.navigator.msPointerEnabled
      ? { start: "MSPointerDown", move: "MSPointerMove", end: "MSPointEURp" }
      : {
  ...
  function C(a, b, c) {
    if (!b) return !0;
    c.xSteps[a] =
      u([c.xVal[a], c.xVal[a + 1]], b) / t(c.xPct[a], c.xPct[a + 1]);
  ...
  function Y(a, c, f) {
    ...
    function v(a) {
      m(a, c.cssClasses.target),
        ...
        0 === c.ort
          ? m(a, c.cssClasses.horizontal)
          : m(a, c.cssClasses.vertical),
    ...
    function x() {
      ...
      Q("update", function (b, d, e) {
        if (a[d]) {
          var f = b[d];
          !0 !== c.tooltips[d] && (f = c.tooltips[d].to(e[d])),
            (a[d].innerHTML = f);
        }
      });
    }
    ...
    function B(a, b, d) {
      ...
      return (
        ...
        m(
          g,
          0 === c.ort ? c.cssClasses.pipsHorizontal : c.cssClasses.pipsVertical
        ),
    ...
    function L(a, b) {
      b.handle && (n(b.handle, c.cssClasses.active), (ua -= 1)),
        ...
        0 === ua &&
          ...
          _(),
          a.cursor &&
            ((Aa.style.cursor = ""), Aa.removeEventListener("selectstart", d))),
