    ...
    (a.prototype = {
      initialize: function (t, i) {
        return t.data("__parallax")
          ? this
          : ((this.$el = t), this.setData().setOptions(i).build(), this);
      },
      setData: function () {
      ...
      setOptions: function (t) {
        return (
          (this.options = i.extend(!0, {}, a.defaults, t, {
            wrapper: this.$el,
          })),
          this
        );
      ...
      build: function () {
        ...
        (o = i('<div class="parallax-background"></div>')).css({
          "background-image":
            "url(" + s.options.wrapper.data("image-src") + ")",
