...
(function ($) {
    ...
    var recalculateLimits = function () {
      for (var i = 0, len = elements.length; i < len; i++) {
        ...
        var $container = options.containerSelector
          ? $this.closest(options.containerSelector).length
    ...
    var onScroll = function () {
      ...
      for (var i = 0, len = elements.length; i < len; i++) {
        ...
        if (prevDataTo[i] != data.to) {
          if (
            fixedSideBottom[i] &&
            $this.outerHeight() + $this.offset().top + data.pad.bottom <
        ...
        if (isFitToTop) {
          ...
          $this.outerHeight() + data.pad.top + data.pad.bottom >
            window_height ||
          fixedSideTop[i] ||
          fixedSideBottom[i]
        ) {
          ...
          if (scrollY + data.pad.top - padTop <= data.parentTop) {
            ...
            if (scrollY >= lastScrollY) {
              ...
              if (fixedSideBottom[i]) {
                ...
                !fixedSideTop[i] &&
                $this.offset().top >= scrollY + data.pad.top
              ) {
                // Pin the top.
                fixedSideTop[i] = true;
  ...
  Sticky.prototype = {
    ...
    build: function () {
      ...
      setTimeout(function () {
        if (
          typeof Wolmart.sticky_top_height != "undefined" &&
          $el.data("themePin").pad
        ) {
