    ...
    t.fn.themePin = function (o) {
          ...
          for (var e = 0, s = i.length; e < s; e++) {
            ...
            if (o.minWidth && n.width() <= o.minWidth)
              ...
              if (void 0 !== f) {
                ...
                void 0 !== o.paddingOffsetTop
                  ? (l.top += parseInt(o.paddingOffsetTop, 10))
                  : (l.top += 18),
                  void 0 !== o.paddingOffsetBottom
                    ? (l.bottom = parseInt(o.paddingOffsetBottom, 10))
                    : (l.bottom = 0);
            ...
            for (
              ...
              if (m) {
                ...
                if (
                  ...
                  c[d] != m.to &&
                    r[d] &&
                    u.outerHeight() + u.offset().top + m.pad.bottom < e + f &&
                    (r[d] = !1),
                  b)
                ) {
                  ...
                  u.outerHeight() + m.pad.top + m.pad.bottom > f ||
                  p[d] ||
                  r[d]
                ) {
                  var T = parseInt(u.parent().parent().css("padding-top"));
                  e + m.pad.top - T <= m.parentTop
                    ...
                    ? p[d]
                      ? ((p[d] = !1),
                        ...
                        o.activeClass && u.addClass(o.activeClass))
                      : !r[d] &&
                        u.outerHeight() + u.offset().top + m.pad.bottom <
                          e + f &&
                        ((r[d] = !0),
                        !("fixed" == u.css("position")) &&
                          u
      ...
      return (
        this.each(function () {
          ...
          (e && e.update) ||
            (i.push(o),
            t("img", this).one("load", function () {
              h && Riode.deleteTimeout(h), (h = Riode.requestTimeout(f, 20));
            }),
            (e.update = l),
        ...
        t(this).on("recalc.pinleft", function (e, s) {
          !(function (e) {
            void 0 === e && (e = 400);
            for (var s = 0, a = i.length; s < a; s++) {
              ...
              if (p) {
                var r = o.containerSelector
                  ? n.closest(o.containerSelector).length
                    ? n.closest(o.containerSelector)
                    : t(o.containerSelector)
                  : t(document.body);
                if ("fixed" == n.css("position")) {
                  var c = n.offset().top - r.offset().top;
                  n.css({ position: "absolute", left: "", top: c, bottom: "" }),
                    setTimeout(function () {
                      n.css({
                        left: n.offset().left,
                        top: p.pad.top,
